      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:justify-center flex-1">
            <Link to="/auth/instructor-home" className="nav-link mx-4">
              Home
            </Link>
            <Link to="/instructor-profile" className="nav-link mx-4">
              Profile
            </Link>
            <Link to="/create-course" className="nav-link mx-4">
              Create Course
            </Link>
            <Link to="/manage-courses" className="nav-link mx-4">
              Manage Courses
            </Link>
          </div>
